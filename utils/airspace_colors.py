...
level_2_palette= {
    ...
    "Goblet cells":               "#7EB5A6",
    "Basal cells":                "#4A7B6F",
    "Proliferating Basal cells":  "#1F5848",
    "Secretory epithelial cells": "#3E564E",
    "AT1 cells":                  "#A8C5A0",
    "AT2 cells":                  "#6B9E78",
    "Proliferating AT2 cells":    "#27432F",
    # Fibroblasts
    "Adventitial fibroblasts":    "#C4956A",
    "CTHRC1+ fibroblasts":        "#B07D50",
    "Alveolar fibroblasts":       "#CB7111",
    "Alveolar fibroblasts (collagen high)":           "#E2C49A",
    # Endothelial
    "Lymphatic endothelial cells":               "#8B7CB3",
    "Pulmonary vein endothelial cells":           "#A08DB8",
    "Blood endothelial cells":    "#6B5E9E",
    "Capillary endothelial cells":               "#B8A9CC",
    "Pulmonary artery endothelial cells":         "#7A6EA8",
    "Pericytes":                                 "#C5B8D6",
    # Macrophages & monocytes
    "Lipid-associated macrophages":   "#B56355",
    "Interstitial macrophages":       "#D4957F",
    "Airway/Alveolar macrophages":    "#A05A4A",
    "Monocytes/Neutrophils":          "#C17B6E",
    # T cells & NK cells
    "T cells":      "#7E9E6E",
    "CD4+ T cells": "#92B080",
    "CD8+ T cells": "#5E7E50",
    "Natural killer cells":     "#B5C99A",
    # Other immune
    "B cells":         "#6E8FAA",
    "Plasma cells":    "#5A7A9A",
    "Lymphocytes":     "#344774",
