...
def main():
    """Main function to run PCA analysis on pseudobulk data."""
    # Set directory
    path = Path(
        "/rds/general/user/sep22/projects/phenotypingsputumasthmaticsaurorawellcomea1/live/Sara_Patti/009_ST_Xenium"
    )
    input_dir = path / "output/pb/pb_data_concatenated"
    ...
    df = pd.read_csv(input_dir / "pseudobulk_matrix_ROI.csv", index_col=0)
    meta = pd.read_csv(input_dir / "pseudobulk_metadata_ROI.csv", index_col=0)
