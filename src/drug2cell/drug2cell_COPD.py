...
drugs_of_interest = [
    ...
    ## SABAs
    "CHEMBL714|ALBUTEROL",
    "CHEMBL3989693|LEVALBUTEROL TARTRATE",  # used in inhaler
    ## SAMA
    "CHEMBL1621597|IPRATROPIUM",
    "CHEMBL193240|ROFLUMILAST",
    "CHEMBL1355736|THEOPHYLLINE",  # used less often now
    ## LABAs
    "CHEMBL1263|SALMETEROL",
    "CHEMBL605846|OLODATEROL",
    # LAMAs
    "CHEMBL3545181|TIOTROPIUM BROMIDE",
    "CHEMBL1187833|UMECLIDINIUM"
    # New approvals
    "CHEMBL4594287|ENSIFENTRINE",
    "CHEMBL2108675|DUPILUMAB",
    "CHEMBL2108429|MEPOLIZUMAB",
    # Clinical trials
    "CHEMBL1742991|BENRALIZUMAB",
    "CHEMBL4594594|ITEPEKIMAB",
