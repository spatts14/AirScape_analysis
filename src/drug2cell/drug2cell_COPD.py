...
drugs_of_interest = [
    ...
    # IPF clinical trial
    "CHEMBL2142592|TALADEGIB",
    "CHEMBL1237119|TREPROSTINIL",
    # Of interest based on cell types
    "CHEMBL93|ZILEUTON",  # MO
    "CHEMBL4594608|AXATILIMAB",  # MO
    "CHEMBL2108282|CATRIDECACOG",  # MO
    "CHEMBL1743010|ELOTUZUMAB",  # Plasma cells
    "CHEMBL518924|MAVORIXAFOR",  # B cells
    "CHEMBL1201608|MUROMONAB-CD3",  # T cells
    "CHEMBL1201575|EFALIZUMAB",  # T cells
    "CHEMBL2108709|COLLAGENASE CLOSTRIDIUM HISTOLYTICUM",  # CTHRC1
    "CHEMBL2095222|OCRIPLASMIN",  # CTHRC1
]
...
# Subset to COPD and MICA samples
